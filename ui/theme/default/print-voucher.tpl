...
<page size="A4">
		...
		<div id="printable">
			{foreach $v as $vs}
			{$jml = $jml + 1}
		<div class="box" style="background-image:url({$_theme}/vouchers/{number_format($vs['price'],0,$_c['dec_point'],$_c['thousands_sep'])}.jpg);background-size: 192px 46px;">
  ...
  <!--<div class="kanan">
	<div class="qrcode" id="{$vs['code']}"></div>
		...
		qr.addData("http://wifiprabayar.web.id/hotspot/login?username={$vs['code']}&password={$vs['code']}");
		qr.make();
