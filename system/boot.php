...
if (isset($_SESSION['notify'])) {
    ...
    if ($ntype == 's') {
		$ui->assign('notify','<center><ion-chip color="success"><ion-icon name="checkmark-done" color="success"></ion-icon><ion-label>' . $notify . '</ion-label></ion-chip></center>');
    } else {
		$ui->assign('notify','<center><ion-chip color="danger"><ion-icon name="alert-circle" color="danger"></ion-icon><ion-label>' . $notify . '</ion-label></ion-chip></center>');
    }
