...
$_L['Register_Member'] = 'Register as Member<br><small style="color:red">besure you already buy a wi-fi voucher</small>';
...
$_L['Select_Plan'] = 'Select Wi-FI Package';
...
$_L['Welcome_Text_Admin'] = ' is a billing Hotspot and PPPOE for Mikrotik using PHP and Mikrotik API to comunicate with router. If you get more profit with this application, please <a href="https://invoice.xendit.co/donation/daffadev" target="_blank">DONATE</a> us.<br>Check Update <a href="https://github.com/7897git/phpmixbill-mod.v5.0.1-r.1.git" target="_blank" style="color:yellow;font-weight:900;">HERE</a>';
